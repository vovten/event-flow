...
class EventFlowDisabledAutoConfigurationIntegrationTest {
    ...
    void shouldNotContainEventPublisherBean() {
        // then
        assertThat(context.getBeanNamesForType(com.github.vovten.eventflow.publisher.EventPublisher.class)).isEmpty();
    }
    ...
    void shouldNotContainEventDispatcherBean() {
        // then
        assertThat(context.getBeanNamesForType(com.github.vovten.eventflow.dispatcher.EventDispatcher.class)).isEmpty();
    }
