...
class EventTypeRegistryTest {
    ...
    void defaultAllowsEventFlowPackage() {
        ...
        assertTrue(EventTypeRegistry.isAllowed("io.github.vovten.eventflow.event.Event"));
        assertTrue(EventTypeRegistry.isAllowed("io.github.vovten.eventflow.test.TestEvent"));
    }
