 ...
 * <pre>{@code
 * InTransport transport = new KafkaInTransport(
 *     "localhost:9092",
 *     "events",
 *     "my-group"
 * );
...
public class KafkaInTransport implements InTransport {
     ...
     */
    public KafkaInTransport(Consumer<String, String> kafkaConsumer, List<String> topics) {
     ...
     */
    public KafkaInTransport(Consumer<String, String> kafkaConsumer,
                            List<String> topics,
