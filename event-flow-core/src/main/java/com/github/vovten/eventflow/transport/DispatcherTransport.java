...
/**
 * Dispatcher transport — a mechanism for receiving events from external sources.
 * <p>
 * A dispatcher transport is responsible for receiving events from a source
 ...
 * <b>Implementations:</b>
 * <ul>
 *   <li>InMemoryDispatcherTransport — receives events from in-memory queue</li>
 *   <li>KafkaDispatcherTransport — receives events from Kafka topic</li>
 * </ul>
 * <p>
 * <b>Usage example:</b>
 * <pre>{@code
 * DispatcherTransport transport = new KafkaDispatcherTransport(bootstrapServers, "events", "group-1");
 ...
 * @since 2026-03-06
 */
public interface DispatcherTransport {
