 ...
 *   <li>Compatible with other decorators (Retry, Transactional)</li>
 * </ul>
 * <p>
 * <b>When to use:</b>
 * <ul>
 ...
 *     new RetryEventPublisherDecorator(
 *         new ChannelEventPublisher(channels),
 ...
 * <pre>{@code
 * // Transactional + silent (log errors but don't rollback transaction)
 * EventPublisher publisher = new SilentEventPublisher(
