 ...
 *   <li>Transactional (deferred) publishing</li>
...
public class EventPublisherBuilder {
     ...
     * Requires Spring transaction management.
     *
     * @return this builder
     */
    public EventPublisherBuilder transactional() {
    ...
    public EventPublisher build() {
        ...
        // Apply transactional if configured
        if (transactional) {
    ...
    public EventPublisher buildAndLog() {
        ...
        log.info("Built EventPublisher with configuration: channels={}, retry={}, transactional={}, silent={}, customDecorators={}",
                channels.size(),
